...
class Register extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final registerStateR = ref.read(registerState);
                            ...
                            children: [
                                  ...
                                  Expanded(
                                    child: ElevatedButton(
                                      style: ElevatedButton.styleFrom(
                                        ...
                                        elevation: 0,
                                        backgroundColor: registerStateR.isBrand
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: TextField(
                                    controller: registerStateR.email,
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(10),
                                  child: TextField(
                                    controller: registerStateR.pass,
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(10),
                                  child: TextField(
                                    controller: registerStateR.coPass,
                                    obscureText: registerStateR.isShowPass2
                                        ? false
                                        : true,
                                    decoration: InputDecoration(
                                      suffixIcon: GestureDetector(
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    final res =
                                        await registerStateR.register(context);
                                    if (res) {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
